...
**h. Create documentation** As the minimum example a README file helps ensure that your data can be correctly interpreted and reanalysed by others. A README plain text is good practice, for example [DataDryad Readme](https://datadryad.org//pages/readme).
