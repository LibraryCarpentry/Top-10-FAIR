...
Activity 1: [Promoting FAIR principles in the healthcare field](http://www.dcc.ac.uk/blog/promoting-fair-principles-healthcare-field) by the Digital Curation Centre (DCC) from January 2019. Highlights: The sensitive nature of patient data and additional concerns for these data include security and anonymisation of data subjects and, although not the primary concern from a technical aspect, these are a major component that is considered. For more information visit [https://www.fair4health.eu/](https://www.fair4health.eu/).
