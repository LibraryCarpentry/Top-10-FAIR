...
[Identifiers are essential to the human-machine interoperation](https://www.go-fair.org/fair-principles/f1-meta-data-assigned-globally-unique-persistent-identifiers/). Assigning globally unique persistent identifiers “is arguably the most important FAIR principle, because it will be hard to achieve other aspects of FAIR without them” *F1* (GO FAIR, 2017). Persistent identifiers or PIDs help find and collect data accurately, enable proper citation by collecting citation _metrics_ about the use of a dataset, article or data generator (e.g. instrument, software, workflow). For the researcher, persistent identifiers enable disambiguation of people, and enable linking existing works as well as promoting wider dissemination of research.
